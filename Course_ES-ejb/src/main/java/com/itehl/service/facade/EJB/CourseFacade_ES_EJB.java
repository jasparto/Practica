 ...
 * @author bryan.silva
 */
@Stateless(name = "courseFacade_EJB", mappedName = "ejb/courseFacade_EJB")
public class CourseFacade_ES_EJB implements ICourseFacade_ES_EJB {
    ...
    public TxStatusType createCourse(com.itehl.education.schema.coursetype.v1.CourseTypeMsg requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("createCourse (" + requestParam.getCourse() + ") - start");
        }
        try {
            type.setStatus(
                    ...
                    CourseConvert.
                    TypeConvertToEntity(
                    requestParam.getCourse())));
            
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByUser (" + requestParam.getCourse() + ") - return TxStatusType = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByUser (" + requestParam.getCourse() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByUser (" + requestParam.getCourse() + ") - end");
        }
        return type;
    }
    ...
    public TxStatusType createTopic(com.itehl.education.schema.coursetype.v1.TopicsTypeMsg requestParam) throws BusinessExceptionMsg {
        ...
        TxStatusType type = new TxStatusType();
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("createCourse (" + requestParam.getTopics() + ") - start");
        }
        try {
            type.setStatus(implement.createTopic(TopicConvert.TypeConvertToEntity(requestParam.getTopics())));
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByUser (" + requestParam.getTopics() + ") - return TxStatusType = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByUser (" + requestParam.getTopics() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByUser (" + requestParam.getTopics() + ") - end");
        }
        return type;
    }
    ...
    public TxStatusType updateCourse(com.itehl.education.schema.coursetype.v1.CourseTypeMsg requestParam) throws BusinessExceptionMsg {
        ...
        TxStatusType type = new TxStatusType();
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("updateCourse (" + requestParam.getCourse() + ") - start");
        }
        try {
            type.setStatus(implement.updateCourse(CourseConvert.TypeConvertToEntity(requestParam.getCourse())));
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("updateCourse (" + requestParam.getCourse() + ") - return TxStatusType = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("updateCourse (" + requestParam.getCourse() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("updateCourse (" + requestParam.getCourse() + ") - end");
        }
        return type;
    }
    ...
    public TxStatusType updateTopic(com.itehl.education.schema.coursetype.v1.TopicsTypeMsg requestParam) throws BusinessExceptionMsg {
        ...
        TxStatusType type = new TxStatusType();
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("updateCourse (" + requestParam.getTopics() + ") - start");
        }
        try {
            type.setStatus(implement.updateTopic(TopicConvert.TypeConvertToEntity(requestParam.getTopics())));
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("updateCourse (" + requestParam.getTopics() + ") - return TxStatusType = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("updateCourse (" + requestParam.getTopics() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("updateCourse (" + requestParam.getTopics() + ") - end");
        }
        return type;
    }
    ...
    public com.itehl.fwk.schema.commontype.v1.TxStatusType deleteTopic(com.itehl.education.schema.coursetype.v1.DeleteTopicsRequestType requestParam) throws BusinessExceptionMsg {
        ...
        TxStatusType type = new TxStatusType();
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("deleteTopic (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - start");
        }
        try {
            type.setStatus(implement.removeTopic(requestParam.getGuid(), requestParam.getUserGuid()));
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("deleteTopic (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - return TxStatusType = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("deleteTopic (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("deleteTopic (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public TxStatusType deleteCourse(com.itehl.education.schema.coursetype.v1.DeleteCourseRequestType requestParam) throws BusinessExceptionMsg {
        ...
        TxStatusType type = new TxStatusType();
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("deleteCourse (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - start");
        }
        try {
            type.setStatus(implement.removeCourse(requestParam.getGuid(), requestParam.getUserGuid()));
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("deleteCourse (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - return TxStatusType = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("deleteCourse (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("deleteCourse (" + requestParam.getGuid() + " - " + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    @Override
    public GetCourseByIdResponseType getCourseById(
            com.itehl.education.schema.coursetype.v1.GetCourseByIdRequestType 
                    requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCourseById (" + requestParam.getUserGuid() + ") - start");
        }
        try {

            type.getCourse().
            addAll(
            CourseConvert.EntityConvertToTypeList(
            implement.getCourseById(
            requestParam.getGuid())));
            

            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCourseById (" + requestParam.getGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCourseById (" + requestParam.getGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCourseById (" + requestParam.getGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByUserResponseType getCoursesByUser(com.itehl.education.schema.coursetype.v1.GetCoursesByUserRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByUser (" + requestParam.getUserGuid() + ") - start");
        }
        try {

            type.getCourse().addAll(CourseConvert.EntityConvertToTypeList(implement.getCoursesByUser(requestParam.getUserGuid())));

            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByUser (" + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByUser (" + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByUser (" + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByNameResponseType getCoursesByName(com.itehl.education.schema.coursetype.v1.GetCoursesByNameRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByAuthorResponseType getCoursesByAuthor(com.itehl.education.schema.coursetype.v1.GetCoursesByAuthorRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByAuthor (" + requestParam.getAuthor() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByAuthor (" + requestParam.getAuthor() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByAuthor (" + requestParam.getAuthor() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByAuthor (" + requestParam.getAuthor() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByLevelResponseType getCoursesByLevel(com.itehl.education.schema.coursetype.v1.GetCoursesByLevelRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByAuthor (" + requestParam.getLevel() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByAuthor (" + requestParam.getLevel() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByAuthor (" + requestParam.getLevel() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByAuthor (" + requestParam.getLevel() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByScoreResponseType getCoursesByScore(com.itehl.education.schema.coursetype.v1.GetCoursesByScoreRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByScore (" + requestParam.getScore() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByScore (" + requestParam.getScore() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByScore (" + requestParam.getScore() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByScore (" + requestParam.getScore() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByTargetResponseType getCoursesByTarget(com.itehl.education.schema.coursetype.v1.GetCoursesByTargetRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByTarget (" + requestParam.getTarget() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByTarget (" + requestParam.getTarget() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByTarget (" + requestParam.getTarget() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByTarget (" + requestParam.getTarget() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByStatusResponseType getCoursesByStatus(com.itehl.education.schema.coursetype.v1.GetCoursesByStatusRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByTarget (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByTarget (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByTarget (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByTarget (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByHoursResponseType getCoursesByHours(com.itehl.education.schema.coursetype.v1.GetCoursesByHoursRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByHours (" + requestParam.getHours() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByHours (" + requestParam.getHours() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByHours (" + requestParam.getHours() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByHours (" + requestParam.getHours() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByCategoryResponseType getCoursesByCategory(com.itehl.education.schema.coursetype.v1.GetCoursesByCategoryRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByCategory (" + requestParam.getCategory() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByCategory (" + requestParam.getCategory() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByCategory (" + requestParam.getCategory() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByCategory (" + requestParam.getCategory() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByReleaseDateResponseType getCoursesByReleaseDate(com.itehl.education.schema.coursetype.v1.GetCoursesByReleaseDateRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByReleaseDate (" + requestParam.getReleaseDate() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByReleaseDate (" + requestParam.getReleaseDate() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByReleaseDate (" + requestParam.getReleaseDate() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByReleaseDate (" + requestParam.getReleaseDate() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByModeResponseType getCoursesByMode(com.itehl.education.schema.coursetype.v1.GetCoursesByModeRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByMode (" + requestParam.getMode() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByMode (" + requestParam.getMode() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByMode (" + requestParam.getMode() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByMode (" + requestParam.getMode() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetCoursesByPriceResponseType getCoursesByPrice(com.itehl.education.schema.coursetype.v1.GetCoursesByPriceRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByPrice (" + requestParam.getPrice() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getCoursesByPrice (" + requestParam.getPrice() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getCoursesByPrice (" + requestParam.getPrice() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getCoursesByPrice (" + requestParam.getPrice() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetTopicsByNameResponseType getTopicsByName(com.itehl.education.schema.coursetype.v1.GetTopicsByNameRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getTopicsByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getTopicsByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByName (" + requestParam.getName() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetTopicsByUserResponseType getTopicsByUser(com.itehl.education.schema.coursetype.v1.GetTopicsByUserRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByUser (" + requestParam.getUserGuid() + ") - start");
        }
        try {

            type.getTopics().addAll(TopicConvert.EntityConvertToTypeList(implement.getTopicsByUser(requestParam.getUserGuid())));

            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getTopicsByUser (" + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getTopicsByUser (" + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByUser (" + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetTopicsByDescriptionResponseType getTopicsByDescription(com.itehl.education.schema.coursetype.v1.GetTopicsByDescriptionRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByName (" + requestParam.getDescription() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getTopicsByName (" + requestParam.getDescription() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getTopicsByName (" + requestParam.getDescription() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByName (" + requestParam.getDescription() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
    ...
    public GetTopicsByStatusResponseType getTopicsByStatus(com.itehl.education.schema.coursetype.v1.GetTopicsByStatusRequestType requestParam) throws BusinessExceptionMsg {
        ...
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByStatus (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - start");
        }
        try {
            ...
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getTopicsByStatus (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getTopicsByStatus (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getTopicsByStatus (" + requestParam.isStatus() + "," + requestParam.getUserGuid() + ") - end");
        }
        return type;
    }
...
//            type.getCourse().addAll(CourseConvert.EntityConvertToTypeList(implement.getCoursesByMaterial(requestParam.getUserGuid(), requestParam.getMaterial())));
    ...
    public String getName() {
        return "CourseFacade_ES_WS";
    }

    @Override
    public List<CourseType> getAllCourses() throws BusinessExceptionMsg {
        implement = new CourseImplement();
        List<CourseType> type = new ArrayList<CourseType>();
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getAllCourses () - start");
        }
        try {

            type.addAll(CourseConvert.EntityConvertToTypeList(implement.getAllCoruses()));

            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).info("getAllCourses () - return List = " + type + "");
        } catch (Exception e) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).error("getAllCourses () - error", e);
            throw new BusinessExceptionMsg(e.getMessage(), ConstructException.exceptionType(CourseFacade_ES_EJB.class, e));
        }
        if (LoggerUtil.outLogger(CourseFacade_ES_EJB.class).isDebugEnabled()) {
            LoggerUtil.outLogger(CourseFacade_ES_EJB.class).debug("getAllCourses () - end");
        }
        return type;
    }
